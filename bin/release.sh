...
# cd /Documents/Go/package2/src/github.com/admpub/leanote/bin
...
function build()
{
	...
	GOOS=$1 GOARCH=$2 go build -o leanote-$1-$2$suffix github.com/admpub/leanote/app/tmp
}
...
# make link
# cd $tmp/leanote/bin
# ln -s ../../../../ ./src/github.com/admpub/leanote
