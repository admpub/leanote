...
import (
	...
	_ "github.com/admpub/leanote/app"
	controllers "github.com/admpub/leanote/app/controllers"
	admin "github.com/admpub/leanote/app/controllers/admin"
	api "github.com/admpub/leanote/app/controllers/api"
	member "github.com/admpub/leanote/app/controllers/member"
	info "github.com/admpub/leanote/app/info"
	_ "github.com/admpub/leanote/app/lea/binder"
	_ "github.com/admpub/leanote/app/lea/captcha"
		...
		[]*revel.MethodType{
			...
			&revel.MethodType{
				...
				Args: []*revel.MethodArg{ 
					...
					&revel.MethodArg{Name: "emailSSL", Type: reflect.TypeOf((*string)(nil)) },
				},
				RenderArgNames: map[int][]string{ 
				},
			},
